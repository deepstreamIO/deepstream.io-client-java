...
public class RpcResponseTest {
    ...
    public void sendsAckMessageAutomatically() {
        ...
        Assert.assertEquals(Util.convertChars("P|A|addTwo|123+"), connectionMock.lastSentMessage);
    }
    ...
    public void sendsTheResponse() {
        RpcResponse response = new RpcResponse( connectionMock, "addTwo", "123" );
        response.send( 14 );
        Assert.assertEquals(Util.convertChars("P|RES|addTwo|123|N14+"), connectionMock.lastSentMessage);
    }
    ...
    public void rejectsTheMessage() {
        RpcResponse response = new RpcResponse( connectionMock, "addTwo", "123" );
        response.reject();
        Assert.assertEquals(Util.convertChars("P|REJ|addTwo|123+"), connectionMock.lastSentMessage);
    }
    ...
    public void errorsTheMessage() {
        ...
        Assert.assertEquals(Util.convertChars("P|E|Error Message|addTwo|123+"), connectionMock.lastSentMessage);
    }
